...
def test_attribution():
    ...
    run_test("Customer Journey Builder", build_customer_journeys)

    run_test("First Touch Attribution", first_touch_attribution)

    run_test("Last Touch Attribution", last_touch_attribution)

    run_test("Linear Attribution", linear_attribution)

    run_test("Time Decay Attribution", time_decay_attribution)

    run_test("Position Based Attribution", position_based_attribution)
